...
const fabricOrderListService = {
  ...
  getFabricOrderById: async (orderId) => {
    try {
  ...
  getFabricOrdersByFabricCode: async (fabricId) => {
    try {
      const response = await axios.get(
  ...
  createFabricOrder: async (orderData) => {
    try {
  ...
  updateFabricOrder: async (orderId, orderData) => {
    try {
  ...
  deleteFabricOrder: async (orderId) => {
    try {
