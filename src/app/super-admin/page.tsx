...
export default function SuperAdminPage() {
    ...
    if (!session) {
        return <div className="min-h-screen p-4 text-white">Please log in to access this page.</div>;
    }

    if (session.user?.role !== Role.SUPER_ADMIN) {
        return <div className="min-h-screen p-4 text-white">Access denied. Super Admin privileges required.</div>;
    }

    return (
        <DashboardLayout>
            <div className="min-h-screen p-4">
                <h1 className="text-2xl font-bold mb-4 text-white">Super Admin Panel</h1>
                        ...
                        <div className="bg-gray-800 shadow rounded-lg p-4">
                            ...
                            {isEditing ? (
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => handleResetPassword(selectedUser.id, e.target.value)}
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-300 mb-4">Role: {selectedUser.role}</p>
