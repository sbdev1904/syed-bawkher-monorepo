...
import { Barcode, Edit, Trash2, AlertCircle } from "lucide-react";
              ...
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    ...
                    >
                      <Edit className="h-4 w-4 text-blue-500 hover:text-blue-300" />
                    </Button>
                  </TooltipTrigger>
                  <TooltipContent>
                    <p>Edit Fabric</p>
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button variant="ghost" size="icon" onClick={onPrintClick}>
                      <Barcode className="h-4 w-4 text-green-500 hover:text-green-300" />
                    </Button>
                  </TooltipTrigger>
                  <TooltipContent>
                    <p>Print Barcode</p>
